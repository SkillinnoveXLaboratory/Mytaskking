...
class DesktopThemesSection extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final selected = MobileLocalSettings.colorTheme.value;

    return ValueListenableBuilder<Map<MobileThemeId, Map<String, int>>>(
                ...
                child: ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final palette = MobileThemePalettes.paletteFor(
                      themeId,
                      overrides: MobileLocalSettings.overridesFor(themeId),
                    );
                    ...
                    return _ThemeCard(
                      ...
                      palette: palette,
                      selected: isSelected,
                      onTap: () => MobileLocalSettings.setColorTheme(themeId),
