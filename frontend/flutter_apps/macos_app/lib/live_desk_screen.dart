      ...
      child: ConstrainedBox(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Connect to an approved MyTaskKing Mac, Linux, or Windows computer. Remote control is never enabled without host approval.',
            ...
            Text('My Mac host', style: theme.textTheme.titleLarge),
            const SizedBox(height: 8),
            Card(
              child: Padding(
                padding: const EdgeInsets.all(22),
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      child: ListTile(
        ...
        title: Text(
          '${session['computerName'] ?? 'Mac computer'} (${session['computerId'] ?? ''})',
        ),
