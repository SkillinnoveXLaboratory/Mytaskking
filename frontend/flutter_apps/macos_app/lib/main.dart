...
void main(List<String> args) async {
  ...
  final api = BestieApi(
    ...
    auth: auth,
    userAgent:
        'MyTaskKing-macOS/${Platform.operatingSystem}/${Platform.operatingSystemVersion}',
  );
  final socket =
...
class BestieMacApp extends ConsumerStatefulWidget {
  const BestieMacApp({super.key});

  @override
  ConsumerState<BestieMacApp> createState() => _BestieMacAppState();
}

class _BestieMacAppState extends ConsumerState<BestieMacApp> {
  @override
  void initState() {
    super.initState();
...
class _DesktopLifecycleHostState extends ConsumerState<DesktopLifecycleHost>
  ...
  String get _trayIconPath {
    ...
    final candidates = [
      if (Platform.isMacOS) ...[
        '$exeDir${sep}..${sep}Frameworks${sep}App.framework${sep}Resources${sep}flutter_assets${sep}assets${sep}logo.png',
        '$exeDir${sep}..${sep}Resources${sep}flutter_assets${sep}assets${sep}logo.png',
      ],
      '$exeDir${sep}data${sep}flutter_assets${sep}assets${sep}logo.png',
      '$exeDir${sep}data${sep}flutter_assets${sep}packages${sep}mytaskking_mobile${sep}assets${sep}icon.png',
      '$exeDir${sep}data${sep}flutter_assets${sep}assets${sep}icon.png',
    ];
