...
class DesktopRuntime {
  ...
  static const _autostartLabel = 'com.mytaskking.background-agent';
  ...
  static bool get interceptClose =>
      Platform.isMacOS && _primaryAgent && _backgroundSessionActive;
  static bool get hideOnClose => interceptClose && _backgroundRequested;
  static bool get shouldRunActivityAgent => Platform.isMacOS && _primaryAgent;
  ...
  static Future<void> handoffToBackgroundAgent() async {
    if (!Platform.isMacOS || !_primaryAgent || !_backgroundSessionActive) {
      return;
    }
  ...
  static Future<void> _ensureAutostartRegistration() async {
    ...
    final plistFile = File('${dir.path}/$_autostartLabel.plist');
    final content = '''<?xml version="1.0" encoding="UTF-8"?>
<!DOCTYPE plist PUBLIC "-//Apple//DTD PLIST 1.0//EN" "http://www.apple.com/DTDs/PropertyList-1.0.dtd">
<plist version="1.0">
<dict>
  <key>Label</key>
  <string>$_autostartLabel</string>
  <key>ProgramArguments</key>
  <array>
    <string>$executable</string>
    <string>$startupFlag</string>
  </array>
  <key>RunAtLoad</key>
  <true/>
  <key>KeepAlive</key>
